...
export function initLineWaves(container, options = {}) {
  ...
  if (!container) {
    console.error('LineWaves: container not found');
    return;
  }
  ...
  /* =============================================
     Canvas fixed full screen sebagai background linewaves global.
     ============================================= */
  ...
  gl.canvas.style.zIndex = '0';           /* di atas background gelap, di bawah konten */
  gl.canvas.style.pointerEvents = 'none'; /* tidak menghalangi klik */
  gl.canvas.style.display = 'block';
  gl.canvas.style.opacity = '0.68';
  gl.canvas.style.mixBlendMode = 'screen';

  /* Append langsung ke body agar benar-benar global */
